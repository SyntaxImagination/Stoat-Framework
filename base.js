...
async function init() {
      ...
      configData = await configFile.runConfig();
      ...
      if (httpConfig.http === true || httpsConfig.http === true) {
            try {
                        ...
                        _s.dbConfig.forEach(function (database) {
                              if (
                                    ...
                                    try {
                                          ...
                                          var runDBInstaller = require(_s.misc
                                                .rootPath +
                                                "/" +
                                                _s.paths.model);
                                    ...
                                    log("Database parameters are empty");
                              }
                        });
                  }

                  //Net Connections - Call once after all databases are initialized
                  runConnection();
                  ...
                  log("------------");
                  log(
                        "Error : Application cannot start, no config file defined / config file not found / Invalid config file"
                  );
            }
      }
}
